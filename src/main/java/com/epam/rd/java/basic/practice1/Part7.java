...
public class Part7 {
    ...
    public static String int2str(int number) {
        ...
        if (number >= 1 && number <= 26) {
            result = Character.toString((char) (number + 65 - 1));
            return result;
        }
        // When 2 letters (for example: AA)
            ...
            if (temp == 0) {
                result = result + Character.toString((char) (((number / 26) - 1) + 65 - 1))
                        + Character.toString((char) (26 + 65 - 1));
            }
            // When 2 letters are different
            else {
                result = result + Character.toString((char) ((number - temp) / 26 + 65 - 1))
                        + Character.toString((char) (temp + 65 - 1));
            }
            return result;
        }
        // When 3 letters (for example: AAA)
            ...
            result = result + Character.toString((char) (temp + 65 - 1));
            ourNumber -= temp;
            // for second letter
            temp = ourNumber % (26 * 26);
            result = Character.toString((char) (temp / 26 + 65 - 1)) + result;
            ourNumber -= temp;
            // for first letter
            temp = ourNumber / (26 * 26);
            result = Character.toString((char) (temp + 65 - 1)) + result;
            return result;
        }
        return result;
    }
